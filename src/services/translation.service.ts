...
const translations: { [lang in Language]: { [key: string]: string } } = {
  en: {
    ...
    checkEmailToVerify: 'Please check your email for a verification link to activate your account.',
    resendVerificationEmail: 'Didn\'t receive an email? Resend it.',
    resend: 'Resend',
    ...
    registrationAlmostComplete: 'Registration Almost Complete!',
    // Verification Page
    verifyingAccount: 'Verifying Your Account...',
    verificationSuccess: 'Account Verified!',
    verificationSuccessMessage: 'Your email has been successfully verified. You can now log in.',
    verificationError: 'Verification Failed',
    verificationErrorMessage: 'The verification link is invalid or has expired. Please try registering again or resending the verification email.',
    // Auth Service Messages
    errorUsernameExists: 'Username already exists.',
    errorEmailExists: 'Email is already in use.',
    registerSuccessPending: 'We have sent a verification link to your email address. Please check your inbox to complete your registration.',
    ...
    errorUserNotVerified: 'This account has not been verified. Please check your email.',
    errorEmailNotFound: 'No pending verification found for this email address.',
    verificationEmailResent: 'A new verification email has been sent.',
    errorInvalidToken: 'The verification token is invalid.',
    errorExpiredToken: 'The verification token has expired.',
    verifySuccessAdmin: 'Verification successful! As the first user, you are now an administrator.',
    verifySuccessUser: 'Verification successful! You can now log in.',
    // Admin Panel
  ...
  lv: {
    ...
    emailVerificationRequired: 'Nepieciešama e-pasta verifikācija',
    checkEmailToVerify: 'Lūdzu, pārbaudiet savu e-pastu, lai aktivizētu savu kontu.',
    resendVerificationEmail: 'Nesaņēmāt e-pastu? Nosūtīt vēlreiz.',
    resend: 'Sūtīt',
    backToLogin: 'Atpakaļ uz pieteikšanos',
    resendVerification: 'Nosūtīt verifikāciju vēlreiz',
    // Register Page
    ...
    registrationAlmostComplete: 'Reģistrācija Gandrīz Pabeigta!',
    // Verification Page
    verifyingAccount: 'Verificē jūsu kontu...',
    verificationSuccess: 'Konts Verificēts!',
    verificationSuccessMessage: 'Jūsu e-pasts ir veiksmīgi verificēts. Tagad varat pieslēgties.',
    verificationError: 'Verifikācija Neizdevās',
    verificationErrorMessage: 'Verifikācijas saite ir nederīga vai beidzies tās derīguma termiņš. Lūdzu, mēģiniet reģistrēties vēlreiz vai atkārtoti nosūtīt verifikācijas e-pastu.',
    // Auth Service Messages
    errorUsernameExists: 'Lietotājvārds jau pastāv.',
    errorEmailExists: 'E-pasts jau tiek izmantots.',
    registerSuccessPending: 'Mēs nosūtījām verifikācijas saiti uz jūsu e-pasta adresi. Lūdzu, pārbaudiet savu pastkasti, lai pabeigtu reģistrāciju.',
    ...
    errorUserNotVerified: 'Šis konts nav verificēts. Lūdzu, pārbaudiet savu e-pastu.',
    errorEmailNotFound: 'Šim e-pastam nav gaidošas verifikācijas.',
    verificationEmailResent: 'Jauns verifikācijas e-pasts ir nosūtīts.',
    errorInvalidToken: 'Verifikācijas talons ir nederīgs.',
    errorExpiredToken: 'Verifikācijas talonam ir beidzies derīguma termiņš.',
    verifySuccessAdmin: 'Verifikācija veiksmīga! Kā pirmajam lietotājam, jūs tagad esat administrators.',
    verifySuccessUser: 'Verifikācija veiksmīga! Tagad varat pieslēgties.',
    // Admin Panel
    goToMainSite: 'Doties uz galveno lapu',
    ...
    newPassword: 'Jauna parole (nav obligāti)',
